...
CREATE TABLE IF NOT EXISTS `article_feature` (
  ...
  KEY `fk_article_fature_feature_id` (`feature_id`),
  CONSTRAINT `fk_article_fature_feature_id` FOREIGN KEY (`feature_id`) REFERENCES `feature` (`feature_id`) ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `article_price` (
  ...
  `article_id` int(10) unsigned NOT NULL DEFAULT 0,
  `price` decimal(10,6) unsigned NOT NULL DEFAULT 0.000000,
...
CREATE TABLE IF NOT EXISTS `cart_article` (
  ...
  CONSTRAINT `fk_carte_article_cart_id` FOREIGN KEY (`cart_id`) REFERENCES `cart` (`cart_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
